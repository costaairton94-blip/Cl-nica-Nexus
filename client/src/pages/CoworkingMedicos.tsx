...
export default function CoworkingMedicos() {
  ...
  const diferenciais = [
    ...
    { icon: <MapPin className="w-6 h-6" />,    title: "Fácil de Chegar",   desc: "A 5 min do Metrô Hospital São Paulo, 10 min do AACD-Servidor e Santa Cruz. Seus pacientes chegam sem dificuldade." },
  ];
